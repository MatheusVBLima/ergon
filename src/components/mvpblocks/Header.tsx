...
export function Header() {
  ...
  return (
    <motion.header
      className={`fixed left-0 right-0 top-0 z-150 transition-all duration-300 ${
        isScrolled
        ...
        <div className="flex h-16 items-center justify-between lg:h-20">
          ...
          <div className="hidden items-center space-x-4 lg:flex">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                href="#contact"
                className="inline-flex items-center space-x-2 rounded-full bg-primary px-6 py-2.5 font-medium text-primary-foreground transition-all duration-200 hover:shadow-lg"
              >
            ...
            >
              <div className="mt-4 space-y-2 rounded-xl border border-border bg-background/95 py-4 shadow-xl backdrop-blur-lg">
                ...
                <div className="space-y-2 px-4 py-2">
                  <Link
                    href="#contact"
                    className="block w-full rounded-lg bg-primary py-2.5 text-center font-medium text-primary-foreground transition-all duration-200 hover:shadow-lg"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    Book a Call
                  </Link>
