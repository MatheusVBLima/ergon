...
export function Faq() {
  const faqs: Omit<FAQItemProps, 'index'>[] = [
    {
      question: 'What services does ErgonTech offer?',
      answer:
        "ErgonTech specializes in custom software development, modern web design, and business automation solutions. We help businesses transform their ideas into digital solutions that generate real results and drive growth.",
    },
    {
  ...
  return (
    <section id="faq" className="relative w-full overflow-hidden bg-background">
      {/* Decorative elements */}
        ...
        >
          ...
          >
            FAQs
                        ...
                        <h2 className="mb-4 cursor-crosshair text-4xl font-bold sm:text-3xl">
            Frequently Asked Questions
          </h2>
          <p className="text-sm text-muted-foreground">
            Everything you need to know about ErgonTech
          </p>
        </motion.div>
